    ...
    return (
        <div className="w-full">
            <div className="mb-6 px-4 pt-4">
                <h2 className="text-xl font-bold mb-1">Fulfillment Dashboard</h2>
                <p className="text-sm text-muted-foreground">Manage your physical shipments</p>
            </div>
            ...
            <div className="px-4 pb-4">
                {orders.length === 0 ? (
                    <Card className="p-12 text-center bg-muted/20 border-border/50">
                        ...
                        <h3 className="text-xl font-semibold mb-2">No fulfillment requests</h3>
                        <p className="text-muted-foreground">
                            {statusFilter ? `No ${statusFilter} orders at the moment` : "You don't have any physical product orders to fulfill yet."}
                        </p>
                    </Card>
                ) : (
                                        ...
                                        <div className="flex-1 space-y-3">
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-2 gap-x-6 text-sm">
                                                ...
                                                <div className="flex items-center gap-2.5 text-muted-foreground/80">
                                                    ...
                                                    <span className="font-bold">Qty: {order.quantity || 1}</span>
                                                </div>
                                                <div className="flex items-center gap-2.5 text-muted-foreground/80">
                                        ...
                                        >
                                            <div className="flex items-center justify-between mb-3">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="font-bold text-xs uppercase tracking-widest text-primary/70">Shipping info</span>
                                                </div>
